...
const signUpUser = async (req, res) => {
    ...
    try {
        ...
        // Generate token
        const token = jwt.sign({ userId: newUser._id, role: 'user' }, 'your_jwt_secret', { expiresIn: '1h' });
...
const signUpHR = async (req, res) => {
    ...
    try {
        ...
        // Generate token
        const token = jwt.sign({ userId: newHR._id, role: 'hr' }, 'your_jwt_secret', { expiresIn: '1h' });
