...
const signUpUser = async (req, res) => {
    ...
    const hashedPassword = await bcrypt.hash(password, 10);
        ...
        // Generate token
        const token = jwt.sign({ userId: newUser._id, role: 'user' }, 'process.env.JWT_KEY', { expiresIn: '1h' });
...
console.log(newHR);
    ...
    await newHR.save();
        ...
        // Generate token
        const token = jwt.sign({ userId: newHR._id, role: 'hr' }, 'process.env.JWT_KEY', { expiresIn: '1h' });
